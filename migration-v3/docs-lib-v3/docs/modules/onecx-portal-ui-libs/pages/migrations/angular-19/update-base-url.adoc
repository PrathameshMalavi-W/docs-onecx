...
[NOTE]
====
If your remote component already provides `REMOTE_COMPONENT_CONFIG` in `bootstrap.ts`, remove any duplicate provider from `component.ts` or module-level providers. Keep a single authoritative provider definition.
====
